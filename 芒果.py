...
def getPwd(passwd):
    ...
    function myPassWd(passwd) {
        ...
        function L(i, t) {
            var s, r, e = S(i),
                g = S(t),
                n = t.isNeg;
            if (e < g) return i.isNeg ? ((s = y(A)).isNeg = !t.isNeg,
            i.isNeg = !1,
            t.isNeg = !1,
            r = F(t, i),
            i.isNeg = !0,
            ...
            r = q(r, u),
            e += u;
            for (var o = Math.ceil(e / D) - 1, a = H(t, o - d); - 1 != K(r, a);)++s.digits[o - d],
            r = F(r, a);
            for (var h = o; d < h; --h) {
                ...
                for (var w = s.digits[h - d - 1] * (v * E + c), m = f * M + (l * E + N); m < w;)--s.digits[h - d - 1],
    ...
    return ctx.call("myPassWd", passwd)
